    ...
    <div className="flex-1 overflow-y-auto mb-4 p-4">
      <div className="flex flex-col space-y-4">
        ...
        <div className="flex items-start">
          ...
          <div className="bg-gray-700 p-3 rounded-lg max-w-xs">
            <p className="text-white">Do you want to catch up later?</p>
            <span className="text-xs text-gray-400 block mt-1">10:17 AM</span>
          </div>
        </div>
        ...
        <div className="flex items-start justify-end">
          <div className="bg-green-500 p-3 rounded-lg max-w-xs">
            <p className="text-white">Sure, sounds good!</p>
            <span className="text-xs text-gray-200 block mt-1 text-right">10:18 AM</span>
          </div>
          <div className="w-10 h-10 rounded-full bg-gray-500 flex items-center justify-center text-white ml-3">
            <span className="text-sm font-bold">ME</span> 
          </div>
